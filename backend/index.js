...
const DoctorModel = mongoose.model('doctor', { name: String,email: String, phone: String, password: String, dept: String });
...
const PatientModel = mongoose.model('patient', { name: String,email: String, password: String, gender: String, age: Number, phone: Number, address: String });
...
app.post('/patient', cors(), async (req, res) => {
    ...
    const patientObj = new PatientModel({
        name: name, email: email, password: password,  gender: gender, age: age, address: address, phone: phone
    })
